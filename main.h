...
* @specifier: A character represepuunsigned int convert_percent(va_list args, buffer_t *output,
...
* unsigned char flags, int wid, int prec, unsigned char len);
* unsigned int convert_r(va_list args, bufferva_list args, const char *modifier, char *index);
...
unsigned int convert_di(va_list args, buffer_t *ouout;
/* Handlers */
unsigned char handle_flags(const charar *modifier, char *index);
